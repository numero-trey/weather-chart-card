...
| twelve_hour          | boolean | Locale default           | Set `true` for 12 hour clock, `false` for 24 hour clock.                                           |
| hide_minutes         | boolean | `false`                  | Set `true` to only show the hour in the chart.                                                     |
